...
public class FeatureFileContentRendererTest {
    ...
    public void getRenderedFeatureFileContentTest() {
        ...
        SingleScenario singleScenario = new SingleScenario(featureName, featureLanguage, featureDescription, scenarioName, scenarioDescription, featureTags, backgroundSteps);
    ...
    public void formatDataTableStringTest() {
        ...
        SingleScenario singleScenario = new SingleScenario(featureName, featureLanguage, featureDescription, scenarioName, scenarioDescription, new ArrayList<>(), new ArrayList<>());
    ...
    public void formatDocStringTest() {
        ...
        SingleScenario singleScenario = new SingleScenario(featureName, null,null, scenarioName, null, new ArrayList<>(), new ArrayList<>());
        singleScenario.setSteps(steps);
