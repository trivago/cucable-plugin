...
public class FeatureFileContentRendererTest {
    ...
    public void getRenderedFeatureFileContentTest() {
        ...
        SingleScenario singleScenario = new SingleScenario(featureName, featureDescription, scenarioName, scenarioDescription, featureTags, backgroundSteps);
    ...
    public void formatDocStringTest() {
        ...
        SingleScenario singleScenario = new SingleScenario(featureName, null, scenarioName, null, new ArrayList<>(), new ArrayList<>());
        singleScenario.setSteps(steps);
