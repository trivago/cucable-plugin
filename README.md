...
This can be either a text file or a Java class. The difference is can be seen below:

##### Using a java file as a runner template

If you use a java file (e.g. _src/test/java/some/template/CucableJavaTemplate.java_), all **[CUCABLE:FEATURE]** and **[CUCABLE:RUNNER]** placeholders as well as the **class name** will be substituted for the generated feature file name(s).
