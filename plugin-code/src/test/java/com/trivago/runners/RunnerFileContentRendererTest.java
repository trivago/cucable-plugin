...
public class RunnerFileContentRendererTest {
    ...
    @Test
    public void getRenderedFeatureFileContentWithNameFromTextFileTest() throws Exception {
        String template = "package parallel;\n" +
                "\n" +
                "import cucumber.api.CucumberOptions;\n" +
                "\n" +
                "@CucumberOptions(\n" +
                "    monochrome = false,\n" +
                "    features = {\"parallel/features/[CUCABLE:FEATURE].feature\"},\n" +
                "    plugin = {\"json:target/cucumber-report/[CUCABLE:RUNNER].json\"},\n" +
                "    name = {\"[CUCABLE:NAME]\"}\n" +
                ")\n" +
                "public class [CUCABLE:RUNNER] {\n" +
        ...
        // Pass an empty featureFileNames list and a scenario name.
        List<String> featureFileNames = Collections.emptyList();
    ...
    @Test
    public void getRenderedFeatureFileContentWithNameFromJavaFileTest() throws Exception {
    ...
    @Test(expected = CucablePluginException.class)
    public void missingScenarioNamePlaceholderTest() throws Exception {
        String template = "package parallel;\n" +
                "\n" +
                "package some.package;\n" +
                "import cucumber.api.CucumberOptions;\n" +
