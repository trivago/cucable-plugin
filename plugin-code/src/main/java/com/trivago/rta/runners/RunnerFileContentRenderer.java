...
public class RunnerFileContentRenderer {
     ...
     *
     * @param singleScenarioRunner  The instance of the {@link SingleScenarioRunner}.
     * @param sourceFeatureFilePath The path of the source feature.
    ...
    public String getRenderedRunnerFileContent(
            ...
            final String sourceFeatureFilePath
        ...
        fileString = fileString.replace("[FEATURE_FILE_NAME]", featureFileName);
        fileString = addScenarioInfo(fileString, sourceFeatureFilePath, runnerTemplatePath);
        return fileString;
    }
     ...
     * @param sourceFeatureFilePath   The path of the source feature file.
    ...
    private String addScenarioInfo(
        ...
        return runnerFileContentString
                ...
                .concat(sourceFeatureFilePath.replace("\\", "/"))
                .concat(System.lineSeparator())
