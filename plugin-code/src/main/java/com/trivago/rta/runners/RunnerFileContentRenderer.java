...
public class RunnerFileContentRenderer {
     ...
     */
    public String getRenderedRunnerFileContent(SingleScenarioRunner singleScenarioRunner, final SingleScenario singleScenario) throws MissingFileException {
        String fileString;
        ...
        fileString = addScenarioInfo(fileString, singleScenario);
        return fileString;
    }
     ...
     */
    private String addScenarioInfo(final String runnerFileContentString, final SingleScenario singleScenario) {
        return runnerFileContentString
                .concat(System.lineSeparator() + System.lineSeparator()
                        + "// Source Feature: " + singleScenario.getFeatureFilePath())
